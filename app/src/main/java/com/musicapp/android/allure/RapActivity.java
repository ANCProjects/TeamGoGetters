...
public class RapActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sounds.add(new Sound("Migos","Bad and Boujee",R.raw.migos, R.drawable.music_icon));

        // Custom ArrayAdapter.
        // Overriding getView method.
        SoundAdapter adapter = new SoundAdapter(this, sounds, R.color.category_rap);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                if (result == AudioManager.AUDIOFOCUS_REQUEST_GRANTED) {
                    ...
                    mMediaPlayer = MediaPlayer.create(RapActivity.this, sound.getAudioResourceId());
